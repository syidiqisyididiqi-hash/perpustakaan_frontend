...
export default function EditFinePage() {
  ...
  // simulasi data existing dari API / DB
  const existingFines = [
    { id: 1, user_id: "1", book_id: "1", days: "3", amount: "15000" },
    { id: 2, user_id: "2", book_id: "2", days: "1", amount: "3000" },
  ];
  ...
  useEffect(() => {
    const fine = existingFines.find((f) => f.id.toString() === fineId);
    if (fine) {
      setForm(fine);
    }
  }, [fineId]);
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    console.log("UPDATE DATA FINE:", form);
    ...
    <div className="max-w-2xl mx-auto px-4">
      <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
        ...
        <p className="text-slate-500 text-sm mb-6">
          Edit data denda sesuai kebutuhan
        </p>
