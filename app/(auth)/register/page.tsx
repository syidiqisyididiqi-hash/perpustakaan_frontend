...
export default function RegisterPage() {
  ...
  return(
    ...
    <div
      ...
      style={{
        backgroundImage:
          "url('https://th.bing.com/th/id/OIP.ks8kKSwNXOp8WIR-jqsjRAHaE7?o=7rm=3&rs=1&pid=ImgDetMain&o=7&rm=3')",
      }}
    >
      ...
      <div className="relative z-10 w-full max-w-sm">
        ...
        <div className="backdrop-blur-md bg-white/90 shadow-2xl rounded-xl p-8 border">
